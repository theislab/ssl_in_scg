...
# get split from input arguments
import argparse
...
OUTPUT_DIR = "/lustre/groups/ml01/workspace/mojtaba.bahrami/cellxgene"
split_directory = os.path.join(OUTPUT_DIR, "geneformer_embs", split)
...
if not os.path.exists(os.path.join(split_directory, "tokenized_cells.pickle")):
    ...
    tokenized_cells, cell_metadata = tk.tokenize_data(
        DATA_PATH,
        os.path.join(OUTPUT_DIR, "geneformer_embs"),
        split,
        split=split,
        file_format="h5ad",
    )
...
embs = embex.extract_embs(
    "/home/icb/mojtaba.bahrami/projects/Geneformer/geneformer-12L-30M",
    dataset_path,
    split_directory,
    "embeddings",
)
