...
df = pd.read_csv('/lustre/groups/ml01/workspace/mojtaba.bahrami/ssl_results/embedding/all.csv', index_col=0)
df_pca = df.copy()
...
plot_results_table(pd.concat([df_temp, df_pca.loc['Metric Type'].to_frame().T], axis=0), order=order,
                   save_dir='/lustre/groups/ml01/workspace/mojtaba.bahrami/ssl_results/embedding', suffix='mean')
...
s.get_figure().savefig('/lustre/groups/ml01/workspace/mojtaba.bahrami/ssl_results/embedding/box_plot_overall.png')
...
s.get_figure().savefig('/lustre/groups/ml01/workspace/mojtaba.bahrami/ssl_results/embedding/box_plot_separated.png')
