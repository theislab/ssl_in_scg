...
if __name__ == '__main__':
    ...
    split = 'test'
    df = pd.read_csv(os.path.join(RESULTS_FOLDER, 'embedding', f'{split}_scib_scores.csv', index_col=0))
    ...
    # plt.tight_layout()
    plt.savefig(os.path.join(RESULTS_FOLDER, 'embedding/box_plot_overall.svg'), bbox_inches='tight')
    plt.savefig(os.path.join(RESULTS_FOLDER, 'embedding/box_plot_overall.png'), bbox_inches='tight')
    ...
    ax.set_yticklabels(ax.get_yticklabels(),  **tick_font)
    # plt.tight_layout()
    plt.savefig(os.path.join(RESULTS_FOLDER, 'embedding/box_plot_batch_correction.svg'), bbox_inches='tight')
    plt.savefig(os.path.join(RESULTS_FOLDER, 'embedding/box_plot_batch_correction.png'), bbox_inches='tight')
    ...
    ax.set_yticklabels(ax.get_yticklabels(), **tick_font)
    # plt.tight_layout()
    plt.savefig(os.path.join(RESULTS_FOLDER, 'embedding/box_plot_bio_conservation.svg'), bbox_inches='tight')
    plt.savefig(os.path.join(RESULTS_FOLDER, 'embedding/box_plot_bio_conservation.png'), bbox_inches='tight')
