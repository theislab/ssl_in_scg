...
#SBATCH -J Pert_Sciplex_No_SSL_run1
#SBATCH -p gpu_p
...
python -u scgen_train.py --batch_size 16384 --version 'run1' --lr 1e-5 --weight_decay 1e-5 --dropout 1e-2 --model_type 'Unsupervised' --pretrained_dir '/lustre/groups/ml01/workspace/till.richter/trained_models/pretext_models/masking/CN_Pert_MLP_50pFullSplit_sciplex2020/default/version_0/checkpoints/best_checkpoint_val.ckpt'
