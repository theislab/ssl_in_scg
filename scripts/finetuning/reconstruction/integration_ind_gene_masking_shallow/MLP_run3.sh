...
python -u train.py --decoder --lr=0.001 --weight_decay=0.01 --batch_size=8192 --version='integration_shallow_earlystopping_run3' --dropout=0.05 --stochastic --supervised_subset="Lung_Integration" --batch_integration --freeze_encoder --pretrained_dir="/lustre/groups/ml01/workspace/till.richter/trained_models/pretext_models/masking/CN_MLP_50p/default/version_1/checkpoints/best_checkpoint_val.ckpt" --model_path=/lustre/groups/ml01/workspace/$USER/