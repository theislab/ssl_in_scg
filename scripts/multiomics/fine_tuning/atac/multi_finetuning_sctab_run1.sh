...
#SBATCH -J Supervised_Finetune_scTab_run1
#SBATCH -p gpu_p
...
python train_multi.py --mode 'fine_tuning' --version 'new_big_tfidf_run1' --dropout 0.15740626023302481 --weight_decay 0.0011635827043670439 --learning_rate 8.156092178310426e-05 --pretrained_dir "/lustre/groups/ml01/workspace/till.richter/trained_models/pretext_models/multiomics/atac_multiomics_20M_random_MAE_tfidf/default/version_0/checkpoints/best_checkpoint_val.ckpt"
